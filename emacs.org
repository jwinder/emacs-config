...
(use-package xah-math-input
  :config (progn
            (xah-math-input--add-to-hash [ ["def=" "≝"] ])
...
(global-set-key (kbd "S-M-SPC") 'math-symbol-at-point)
...
(add-to-list 'org-structure-template-alist '("trs" "#+BEGIN_SRC translate :src es :dest en\n?\n#+END_SRC")) ;; traducir español al inglés
(add-to-list 'org-structure-template-alist '("tre" "#+BEGIN_SRC translate :src en :dest es\n?\n#+END_SRC")) ;; translate english to spanish
