...
(setq org--todo-todo-boxed-states '("todo" "incoming" "captured" "unread" "question" "problem" "issue" "shitshow" "alert" "warning")
...
;; todojoe - npm/yarn/binci things, elgot/lsp stuff
;; todojoe -- compilation mode for compile/test commands

(jw-runbook-setup-type
 "js"
 :install (lambda (arg) (jw-js-yarn-command arg "install"))
 :dev 'ignore ;; todojjoe
 :start 'ignore ;; todojoe
 :run 'ignore ;; todojoe
 :compile 'ignore ;; todojoe
 :test (lambda (arg) (jw-js-yarn-command arg "test"))
