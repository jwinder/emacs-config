...
(defvar jw-mode-line-config-show-full-filenames nil)
(defun jw-mode-line-toggle-full-filenames ()
  (interactive)
  (setq jw-mode-line-config-show-full-filenames (not jw-mode-line-config-show-full-filenames)))
...
(defun jw--mode-line-make-buffer-id ()
  (let* ((b (current-buffer))
         ...
         (pwd (jw--pwd))
         (display-name (if (and file-name jw-mode-line-config-show-full-filenames) file-name buffer-name))
    ...
    (list (propertize display-name 'face 'mode-line-buffer-id
                      'help-echo (format "Buffer name: %s\nFile name: %s\nProcess name: %s\npid: %s\npwd: %s\nMode line display: %s"
                                         buffer-name (or file-name "N/A") (or process-name "N/A") (or process-id "N/A") pwd display-name)
