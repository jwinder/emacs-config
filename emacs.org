...
(defun font-size-set (size)
  (interactive "sSize (default 14 big 18): ")
...
(defun transparency-set (value)
  (interactive (list (read-string "0 - 100: " "75")))
  (jw--set-transparency (string-to-number value)))
...
(setq transient-enable-popup-navigation t ;; todojoe -- this acts sorta weird, it doesn't exit the popup when starting the process
      transient-display-buffer-action '(display-buffer-below-selected))

;; todojoe -- this is fixed on master
;; for some reason, the universal arg was set to C-p, breaking C-p navigation
