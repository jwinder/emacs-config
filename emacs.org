...
;; these only work when the cursor is inside of emacs, inside of the fringe
;; currently, not setting the wheel for <left-fringe>, <right-fringe>, <header-line>, <mode-line>, <nil> (the edge)
