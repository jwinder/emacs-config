...
(defun eshell-dwim (arg)
  "Toggle eshell. If in a version control repository, then cd to the root of the repository unless a prefix arg is provided."
  (interactive "P")
...
*** ⚑ change eshell-dwim to be able to open multiple eshells, tagging their name with the current dir
** yasnippet
