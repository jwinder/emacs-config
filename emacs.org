...
;; todojoe -- maybe abstract this away so that it can be reused between package.json, Makefile, etc put it as part of jw-project- functions
...
(defun jw-project-insert-sbt-commands-as-org-links ()
  (interactive)
  (dolist (command '("jw-sbt" "jw-sbt-compile" "jw-sbt-compile 'test" "jw-sbt-test 'all" "sbt-command \"projects\"" "sbt-run-previous-command" "jw-sbt-doc" "jw-sbt-metals-bloop-install"))
