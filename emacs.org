...
(setq jw--current-transparency-alpha 75)
...
(define-key ctl-x-4-map (kbd "R") 'font-size-transparency-alpha-default)
...
(defun global-set-wheel-key-everywhere (key command)
  (global-set-key (kbd key) command)
  (-each '("nil" "right-fringe" "left-fringe" "right-margin" "left-margin" "header-line" "tab-line" "vertical-line" "mode-line")
    (lambda (area) (global-set-key (kbd (format "<%s> %s" area key)) command))))

(global-set-wheel-key-everywhere "<C-wheel-up>" 'font-size-increase)
(global-set-wheel-key-everywhere "<C-wheel-down>" 'font-size-decrease)
(global-set-wheel-key-everywhere "<C-wheel-right>" 'transparency-alpha-increase)
(global-set-wheel-key-everywhere "<C-wheel-left>" 'transparency-alpha-decrease)
#+END_SRC
