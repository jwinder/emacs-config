...
(global-set-key (kbd "M-s S") 'helm-multi-swoop)
...
(defun helm-projectile-projects-helm-projectile-ag (dir)
  ...
  (let ((default-directory dir))
    (call-interactively 'helm-projectile-ag))) ;; helm-do-grep-ag doesn't have anything similar to helm-ag-edit, so stick with helm-ag in projects
