...
(defun jw-js-insert-package-json-scripts-as-org-links ()
  ...
  (let ((script-runner (jw-js--get-script-runner)))
    ...
    (dolist (script-pair (jw-js--package-json-scripts-alist))
      (insert (format "- [[elisp:(compile \"%s run %s\")][%s run %s]] - %s\n" script-runner (car script-pair) script-runner (car script-pair) (cdr script-pair)))
      )))
#+END_SRC
