...
(defun save-buffers-kill-terminal--advice--ask-yes-or-no (original-function &optional arg)
  (if (yes-or-no-p "Is life too much? ") (apply original-function arg) (message "Keep up the good fight!")))
