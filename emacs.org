...
(define-key projectile-mode-map (kbd "C-c p s r") nil) ;; remove original rg keybinding. only use s & g for grepping.
(define-key projectile-mode-map (kbd "C-c p s s") 'counsel-projectile-rg)
(define-key projectile-mode-map (kbd "C-c p s S") 'projectile-basic-grep)
(define-key projectile-mode-map (kbd "C-c p s G") 'projectile-basic-grep)
