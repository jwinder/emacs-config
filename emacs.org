...
(defun counsel-find-file--counsel-grep-action (file) (let ((default-directory ivy--directory)) (counsel-grep nil)))
...
(ivy-add-actions
 ...
 '(("!" counsel-find-file--cmd-dwim-action "cmd-dwim in pwd")
   ...
   ("ss" counsel-find-file--counsel-rg-action "rg in pwd")
   ("sg" counsel-find-file--counsel-grep-action "grep in pwd")
