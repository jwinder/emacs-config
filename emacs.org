...
(let* ((class '((class color) (min-colors 89)))
       ...
       (foreground "#eaeaea")
       (cursor "dark gray")
       (highlight-dark "#14151E")
       (highlight-bright "#103050")
       (comment "#969896")
       (red "#d54e53")
       (orange "goldenrod")
       (yellow "#e7c547")
  ...
  (custom-theme-set-faces
   ...
   `(border ((,class (:background ,highlight-dark))))
   `(highlight ((,class (:inverse-video nil :background ,highlight-dark))))

   `(minibuffer-prompt ((,class (:foreground ,blue))))
   `(region ((,class (:background ,highlight-bright))))
   `(secondary-selection ((,class (:background ,highlight-dark))))
   ...
   `(outline-7 ((,class (:inherit nil :foreground "cyanmarine1"))))
   ...
   `(org-column ((,class (:background ,highlight-dark))))
   ...
   `(erc-header-face ((,class (:foreground ,foreground :background ,highlight-bright))))
   ...
   `(erc-nick-default-face ((,class (:weight normal :foreground ,magenta))))
  ...
  (custom-theme-set-variables
   'jw
   `(fci-rule-color ,highlight-bright)
