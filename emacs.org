...
(defun rcirc-connect-libera ()
  (interactive)
  (rcirc-connect-dwim "irc.libera.chat" 6697 "nick" "nick" "nick" '("#emacs") "password" 'tls)

(defun rcirc-connect-gitter ()
  (interactive)
  (rcirc-connect-dwim "irc.gitter.im" 6667 "username" "username" "username" nil "pass token" 'tls))
#+END_SRC
