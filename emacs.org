...
faster searching hacks
 - todo -- remove helm-ag from deps if helm-projectile switches helm-do-ag to helm-do-grep-ag
 - todo -- cleanup if this gets done: https://github.com/bbatsov/helm-projectile/issues/61
#+BEGIN_SRC emacs-lisp
...
;; overwrite with fire right now until it supports rg
(defun helm-projectile-ag (&optional options)
  (interactive)
  (let ((default-directory (or (projectile-project-root) (error "Not in a project"))))
    (call-interactively 'helm-do-grep-ag)))

(defun helm-projectile-projects-helm-do-grep-ag (dir)
  (let ((default-directory dir))
    (call-interactively 'helm-do-grep-ag)))

(helm-add-action-to-source "Grep-ag in project `M-s a'" 'helm-projectile-projects-helm-do-grep-ag helm-source-projectile-projects)
(helm-projectile-define-key helm-projectile-projects-map (kbd "M-s a") #'helm-projectile-projects-helm-do-grep-ag)
(helm-projectile-define-key helm-projectile-projects-map (kbd "C-s") #'helm-projectile-projects-helm-do-grep-ag) ;; hijack grep's keybinding
#+END_SRC
