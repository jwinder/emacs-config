...
(defconst jw--emacs-visual-areas '(nil right-fringe left-fringe right-margin left-margin header-line tab-line vertical-line mode-line))
...
(defun jw--global-set-wheel-key (key command &optional areas)
...
(jw--global-set-wheel-key "<C-wheel-up>" 'font-size-increase)
(jw--global-set-wheel-key "<C-wheel-down>" 'font-size-decrease)
(jw--global-set-wheel-key "<C-wheel-right>" 'transparency-alpha-increase)
(jw--global-set-wheel-key "<C-wheel-left>" 'transparency-alpha-decrease)
#+END_SRC
