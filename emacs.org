...
(global-set-key (kbd "C-x C-c") 'life-might-be-too-much)
...
(global-set-key (kbd "C-h") nil) ;; remove original help
...
(global-set-key (kbd "M-s j") 'dumb-jump-go) ;; todo -- this is obsolete
...
(global-set-key (kbd "C-M-? b") 'counsel-descbinds)
(global-set-key (kbd "C-M-? f") 'counsel-describe-function)
(global-set-key (kbd "C-M-? v") 'counsel-describe-variable)
(global-set-key (kbd "C-M-? l") 'counsel-find-library)
(global-set-key (kbd "C-c h p") 'counsel-list-process)
