...
(use-package dumb-jump
  ;; :config (setq dumb-jump-selector 'helm) ;; broke with last update due to out of date function call
  )
...
(setq org--todo-todo-boxed-states '("todo" "incoming" "captured" "unread" "question")
      ...
      org--delegated-todo-boxed-states '("delegated" "assigned" "pr" "waiting" "deploying" "note")
...
(org-babel-support-langs
 (list 'awk 'calc 'C 'dot 'emacs-lisp 'haskell 'http 'java 'js 'latex 'lisp
       'makefile 'matlab 'org 'perl 'plantuml 'python 'R 'ruby 'scheme 'shell 'sql))
