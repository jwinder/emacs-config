...
;; (global-set-key (kbd "C-c c") 'org-capture) ;; this binding conflicts with ensime, I don't really use it anyway
...
;; todo
;; helm server crashes a lot for some reason
;; figure out how to fix, and maybe replace a lot of this previous custom sbt stuff with just ensime
;; also -- company inside ensime doesn't seem to use helm for some reason :-(

;; (setq ensime-use-helm t)
;; (add-hook 'scala-mode-hook 'ensime-scala-mode-hook)
;; (add-hook 'sbt-mode-hook 'ensime-scala-mode-hook)
#+END_SRC
