...
(add-hook 'c-mode-hook '(lambda () (tree-sitter-mode 1)))
(add-hook 'c++-mode-hook '(lambda () (tree-sitter-mode 1)))
(add-hook 'sh-mode-hook '(lambda () (tree-sitter-mode 1)))
(add-hook 'ruby-mode-hook '(lambda () (tree-sitter-mode 1)))
(add-hook 'python-mode-hook '(lambda () (tree-sitter-mode 1)))
(add-hook 'java-mode-hook '(lambda () (tree-sitter-mode 1)))
(add-hook 'scala-mode-hook '(lambda () (tree-sitter-mode 1)))
(add-hook 'js-mode-hook '(lambda () (tree-sitter-mode 1)))
(add-hook 'js-json-mode-hook '(lambda () (tree-sitter-mode 1)))
(add-hook 'typescript-mode-hook '(lambda () (tree-sitter-mode 1)))
(add-hook 'css-mode-hook '(lambda () (tree-sitter-mode 1)))
(add-hook 'html-mode-hook '(lambda () (tree-sitter-mode 1)))
(add-hook 'markdown-mode-hook '(lambda () (tree-sitter-mode 1)))
(add-hook 'gfm-mode-hook '(lambda () (tree-sitter-mode 1)))
(add-hook 'yaml-mode-hook '(lambda () (tree-sitter-mode 1)))
(add-hook 'go-mode-hook '(lambda () (tree-sitter-mode 1)))
(add-hook 'terraform-mode-hook '(lambda () (tree-sitter-mode 1)))
#+END_SRC
...
;; suppress undefined binding messages when accidentally hitting left or right.
...
(org-babel-format-lang 'js-json)
(org-babel-format-lang 'json 'js-json)
