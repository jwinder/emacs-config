...
git@github.com:jwinder/emacs.git $HOME/emacs
ln -s $HOME/emacs $HOME/.emacs.d
#+END_SRC

*** You can also create a `private` symlink to a directory in a safe place, containing elisp files with private or personal configs. This works well for irc passwords, tramp helpers, etc.

#+BEGIN_SRC sh :tangle no
ln -s /path/to/your/safe/directory $HOME/emacs/private
#+END_SRC
...
(add-to-list 'eshell-command-aliases-list '("e" "find-file $1"))
(add-to-list 'eshell-command-aliases-list '("emacs" "find-file $1"))
(add-to-list 'eshell-command-aliases-list '("vi" "find-file $1"))
(add-to-list 'eshell-command-aliases-list '("vim" "find-file $1"))
(add-to-list 'eshell-command-aliases-list '("less" "find-file $1"))
(add-to-list 'eshell-command-aliases-list '("cat" "find-file $1"))
(add-to-list 'eshell-command-aliases-list '("git" "hub $*"))
(add-to-list 'eshell-command-aliases-list '("g" "hub $*"))
(add-to-list 'eshell-command-aliases-list '(":q" "exit"))
