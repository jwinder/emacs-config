...
hacky fix for helm-ff M-D shortcut
should be fixed in next bugfix release of helm
https://github.com/emacs-helm/helm/commit/ac9cd9bdd7f7f02886edc3057d9d756981a37bcd#diff-c30ab41edecc9d4b288cf5765f90e290
#+BEGIN_SRC emacs-lisp
...
(org-babel-support-src-template-shortcut 'amm "ammonite")
(org-babel-support-src-template-shortcut 'scala "ammonite") ;; default ob-scala requires brew scala & ensime, which I don't use.
#+END_SRC
