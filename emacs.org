...
(defun jw--is-linux ()
  ...
  (and (not (getenv "WSL_DISTRO_NAME")) (eq system-type 'gnu/linux)))

(defun jw--is-wsl-linux ()
  "Check if running on linux in WSL (windows subsystem for linux)"
  (and (getenv "WSL_DISTRO_NAME") (eq system-type 'gnu/linux)))
