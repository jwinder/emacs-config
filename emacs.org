...
(transient-define-prefix cmd-menu
  "Run commands"
  ["Run command"
   ("!" "cmd-dwim          M-!   C-u to echo area / C-u C-u at point" cmd-dwim)
...
(defun gist-dwim (&optional arg)
  ...
  (interactive "P")
  (gist-region-or-buffer (if arg nil t)))
...
(defun gist-menu--dired-do-gist-public () (interactive) (dired-do-gist))
(defun gist-menu--dired-do-gist-private () (interactive) (dired-do-gist t))
...
(transient-define-prefix gist-menu
  ...
  ["Gist"
   ...
   ("2" "dired-do-gist   private   C-u @ in dired"  gist-menu--dired-do-gist-private)
   ("@" "dired-do-gist   public    @ in dired"      gist-menu--dired-do-gist-public)
   ])
...
(defun jw-todo-backup ()
  (interactive)
  (jw--run-cmd "todo-backup" nil nil nil
               (lambda (proc) ;; after-process-finish
                 (switch-to-buffer (other-buffer))
                 (bury-buffer (process-buffer proc))
