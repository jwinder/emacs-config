...
(defun exercism-io-read-track ()
  (read-string "Track (cpp, ruby, etc): "))

(defun exercism-io-cmd (cmd)
  (interactive "sCommand: ")
  (cmd (format "exercism %s" cmd)))

(defun exercism-io-cmd-sync (cmd)
  (interactive "sCommand: ")
  (shell-command (format "exercism %s" cmd)))
...
(defun exercism-io-fetch (arg)
  (interactive "P")
  (if arg
      (exercism-io-cmd-sync (format "fetch %s" (exercism-io-read-track)))
    (exercism-io-cmd-sync "fetch")))

(defun exercism-io-submit-this-file ()
  (interactive)
  (exercism-io-cmd-sync (format "submit %s" (buffer-file-name))))
